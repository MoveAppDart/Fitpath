...
class UserService {
  ...
  Future<Map<String, dynamic>> updateProfile(Map<String, dynamic> profileData) async {
    try {
      final response = await _apiClient.put(EnvConfig.profileEndpoint, data: profileData);
      return {'success': true, 'data': response};
    } on DioException catch (e) {
  ...
  Future<Map<String, dynamic>> updateUserPreferences(Map<String, dynamic> preferences) async {
    try {
      final response = await _apiClient.put(EnvConfig.userPreferencesEndpoint, data: preferences);
      return {'success': true, 'data': response};
    } on DioException catch (e) {
